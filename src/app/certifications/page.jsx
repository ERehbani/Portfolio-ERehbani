    ...
    <div>
        ...
        <div>
            <div className='image-certificate-container'>
                ...
                <Image src="/Certificates/HenryCertificate.PNG" alt='Henry Certificate' className='image-certificate-henry shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px]' width={666} height={0}/>
            </div>
        ...
        <div>
            <div className='image-certificate-container'>
                ...
                <Image src="/Certificates/EnglishCertificate.png" alt='English Certificate' className='image-certificate-english shadow-[rgba(0,_0,_0,_0.25)_0px_25px_50px_-12px]' width={370} height={0} />
            </div>
            <div className='description-container'>
